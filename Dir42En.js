function Print42(no,d1,c1,d2,c2,d3,c3,d4,nourut){
	...
	function AngkaKeNama(ar){
		...
		if(ar[0]==1){
			...
			mmcvrt = mm;
			nncvrt = nn;
			belakang = "and "+puluh[mmcvrt]+" "+angka[nncvrt];
			if(nn==0)	belakang = "and "+puluh[mmcvrt]+"";
	...
	function MyBilanganPecahan1(){
		var ArSalah = ["Numerator","Denominator","Divisor","Factor"];
		
		var arSoal = [["above","Numerator"],["below","Denominator"]];
	...
	function MyBilanganPecahan2(){
		var arData = [[2,"Two"],[3,"Three"],[4,"Four"],[5,"Five"],[6,"Six"],[7,"Seven"],[8,"Eight"],[9,"Nine"]];
		...
		var arrSalah = [];
		var FPB
		arrSalah = ["One and "+FixNama,FixNama+" and One",FixNama+" One"];
		
		var cbenar = "One "+FixNama;
		var benar = cbenar;
	...
	function MyBilanganPecahan3(){
		...
		var arrSalah = [];
		var FPB
		arrSalah = ["one "+FixNama1+" "+FixNama2,"one "+FixNama2+" "+FixNama1,FixNama2+" "+FixNama1];
		
		var cbenar = FixNama1+" "+FixNama2;
		var benar = cbenar;
	...
	function MyBilanganPecahan12(){
		...
		var arrSalah = [];
		if(a1>b1){
			arBenar.push(""+Nama[0]+"'s ribbon is longer than "+Nama[1]+"'s ribbon");
			arrSalah.push(""+Nama[1]+"'s ribbon is longer than "+Nama[0]+"'s ribbon");
		}else{
			arBenar.push(""+Nama[1]+"'s ribbon is longer than "+Nama[0]+"'s ribbon");
			arrSalah.push(""+Nama[0]+"'s ribbon is longer than "+Nama[1]+"'s ribbon");
		}
		if(a1>c1){
			arBenar.push(""+Nama[0]+"'s ribbon is longer than "+Nama[2]+"'s ribbon");
			arrSalah.push(""+Nama[2]+"'s ribbon is longer than "+Nama[0]+"'s ribbon");
		}else{
			arBenar.push(""+Nama[2]+"'s ribbon is longer than "+Nama[0]+"'s ribbon");
			arrSalah.push(""+Nama[0]+"'s ribbon is longer than "+Nama[2]+"'s ribbon");
		}
		if(b1>c1){
			arBenar.push(""+Nama[1]+"'s ribbon is longer than "+Nama[2]+"'s ribbon");
			arrSalah.push(""+Nama[2]+"'s ribbon is longer than "+Nama[1]+"'s ribbon");
		}else{
			arBenar.push(""+Nama[2]+"'s ribbon is longer than "+Nama[1]+"'s ribbon");
			arrSalah.push(""+Nama[1]+"'s ribbon is longer than "+Nama[2]+"'s ribbon");
		}
		
		if(a1>b1 && a1>c1){
			arBenar.push(""+Nama[0]+"'s ribbon is the longest");
			arrSalah.push(""+Nama[1]+"'s ribbon is the longest");
			arrSalah.push(""+Nama[2]+"'s ribbon is the longest");
		}else if(b1>a1 && b1>c1){
			arBenar.push(""+Nama[1]+"'s ribbon is the longest");
			arrSalah.push(""+Nama[0]+"'s ribbon is the longest");
			arrSalah.push(""+Nama[2]+"'s ribbon is the longest");
		}else{
			arBenar.push(""+Nama[2]+"'s ribbon is the longest");
			arrSalah.push(""+Nama[0]+"'s ribbon is the longest");
			arrSalah.push(""+Nama[1]+"'s ribbon is the longest");
		}
		if(a1<b1 && a1<c1){
			arBenar.push(""+Nama[0]+"'s ribbon is the shortest");
			arrSalah.push(""+Nama[1]+"'s ribbon is the shortest");
			arrSalah.push(""+Nama[2]+"'s ribbon is the shortest");
		}else if(b1<a1 && b1<c1){
			arBenar.push(""+Nama[1]+"'s ribbon is the shortest");
			arrSalah.push(""+Nama[0]+"'s ribbon is the shortest");
			arrSalah.push(""+Nama[2]+"'s ribbon is the shortest");
		}else{
			arBenar.push(""+Nama[2]+"'s ribbon is the shortest");
			arrSalah.push(""+Nama[0]+"'s ribbon is the shortest");
			arrSalah.push(""+Nama[1]+"'s ribbon is the shortest");
		}
	...
	function GambarBilanganPecahan23(nmcanvas,arrs,arrss){
		...
		function CekJaw(){
			...
			if(inside==1){
				...
				ctx.drawImage(base1_image, 85+ (str0-43)*8, 46*0-7,base1_image.width, base1_image.height);
				ctx.drawImage(base1_image, 75+ (str1-35)*8, 46*1-8,base1_image.width, base1_image.height);
				ctx.font = "16px Times New Roman";
				ctx.textAlign = "center";
				ctx.fillText(arrs[1],120 + (str0-43)*8 ,11+46*0);
				ctx.fillText(arrs[2],120 + (str0-43)*8 ,30+46*0);
				ctx.fillText(arrs[4],95 + (str1-35)*8 ,20+46*1);
				ctx.fillText(arrs[5],110 + (str1-35)*8 ,11+46*1);
				ctx.fillText(arrs[6],110 + (str1-35)*8 ,30+46*1);
				ctx.textAlign = "left";
				ctx.font = "16px Times New Roman";
	...
	function GambarBilanganPecahan18awal(nmcanvas,arrs,arrss){
		...
		function CekJaw(){
			...
			if(inside==1){
				var str0 = arrss[0].length;
				var str1 = arrss[1].length;
				ctx.drawImage(base1_image, 200+ (str0-52)*8, 52*0-7,base1_image.width, base1_image.height);
				ctx.drawImage(base1_image, 200+ (str1-52)*8, 52*1-8,base1_image.width, base1_image.height);
				//ctx.drawImage(base1_image, 35+10 + (str0-52)*1 , 52*0-7,base1_image.width, base1_image.height);
				//ctx.drawImage(base1_image, 35+45 + (str1-52)*8 , 52*1-8,base1_image.width, base1_image.height);
				ctx.font = "16px Times New Roman";
				ctx.textAlign = "center";
				ctx.fillText(arrs[0],220 + (str0-52)*8 ,20+52*0);
				ctx.fillText(arrs[1],235 + (str0-52)*8 ,11+52*0);
				ctx.fillText(arrs[2],235 + (str0-52)*8 ,30+52*0);
				ctx.fillText(arrs[3],220 + (str1-52)*8 ,20+52*1);
				ctx.fillText(arrs[4],235 + (str1-52)*8 ,11+52*1);
				ctx.fillText(arrs[5],235 + (str1-52)*8 ,30+52*1);
				ctx.textAlign = "left";
				ctx.font = "16px Times New Roman";
				ctx.fillText(arrss[0],0,20+52*0);
				ctx.fillText(arrss[1],0,20+52*1);
			}
		}
	...
	function GambarBilanganPecahan12(nmcanvas,arrs,arrss){
		...
		function CekJaw(){
			...
			if(inside==1){
				...
				ctx.drawImage(base1_image, 35+150 + (str0-44)*8 , 44*0-7,base1_image.width, base1_image.height);
				ctx.drawImage(base1_image, 35+45 + (str1-25)*8 , 44*1-8,base1_image.width, base1_image.height);
				ctx.drawImage(base1_image, 35+77 + (str2-30)*8 , 44*2-8,base1_image.width, base1_image.height);
				ctx.font = "16px Times New Roman";
				ctx.textAlign = "center";
				ctx.fillText(arrs[0],70+150 + (str0-44)*8 ,11+44*0);
				ctx.fillText(arrs[1],70+150 + (str0-44)*8 ,31+44*0);
				ctx.fillText(arrs[2],70+45 + (str1-25)*8 ,10+44*1);
				ctx.fillText(arrs[3],70+45 + (str1-25)*8 ,30+44*1);
				ctx.fillText(arrs[4],70+77 + (str2-30)*8 ,10+44*2);
				ctx.fillText(arrs[5],70+77 + (str2-30)*8 ,30+44*2);
				ctx.textAlign = "left";
				ctx.font = "16px Times New Roman";
				ctx.fillText(arrss[0],0,20+44*0);
				ctx.fillText(arrss[1],0,20+44*1);
				ctx.fillText(arrss[2],0,20+44*2);
			}
		}
	...
	function GambarBilanganPecahan11awal(nmcanvas,arrs,ss1,ss2){
		...
		function CekJaw(){
			inside++;
			if(inside==1){
				ctx.drawImage(base1_image, 175+90, -6,base1_image.width, base1_image.height);
				ctx.font = "16px Times New Roman";
				ctx.textAlign = "center";
				ctx.fillText(arrs[0],210+90,12);
				ctx.fillText(arrs[1],210+90,32);
				ctx.textAlign = "left";
				ctx.font = "16px Times New Roman";
				ctx.fillText(ss1,0,20);
	...
	function GambarBilanganPecahan10awal(nmcanvas,arrs,ss1,ss2){
		...
		function CekJaw(){
			inside++;
			if(inside==1){
				ctx.drawImage(base1_image, 155, -6,base1_image.width, base1_image.height);
				ctx.font = "16px Times New Roman";
				ctx.textAlign = "center";
				ctx.fillText(arrs[0],190,12);
				ctx.fillText(arrs[1],190,32);
				ctx.textAlign = "left";
				ctx.font = "16px Times New Roman";
				ctx.fillText(ss1,0,20);
	...
	function GetSoal1(){
		...
		var ss
		ss = "In a fraction, the number in "+ArSisi[0]+" is called ...";
	...
	function GetSoal2(canv){
		...
		const DrawPecahan = GambarBilanganPecahan2(canv,ArSisi,"Fractions"," read as ...");
	...
	function GetSoal3(canv){
		...
		const DrawPecahan = GambarBilanganPecahan3(canv,ArSisi,"Fractions"," read as ...");
	...
	function GetSoal4(){
		...
		var Ekskul = NamaEkskul();
		var ss
		ss = "The fraction "+ArSisi[1][0]+" "+ArSisi[1][1]+" is written...";
	...
	function GetSoal5(canv){
		...
		var Ekskul = NamaEkskul();
		var ss
		ss = "The part that is colored yellow has a value ...";
	...
	function GetSoal6(){
		...
		var Nama = NamaTokoh();
		var ss
		ss = Nama[0]+" splits the watermelon into "+ArSisi[6]+" parts. "+Nama[0]+" then eats "+ArSisi[7]+" parts of the watermelon. So the value of the watermelon eaten by "+Nama[0]+" if written in fractional form is ...";
	...
	function GetSoal10(canv1,canv2){
		...
		const DrawPecahan10awal = GambarBilanganPecahan10awal(canv1,ArSisi[1],"The simplest form of "," is ...");
	...
	function GetSoal11(canv1,canv2){
		...
		const DrawPecahan11awal = GambarBilanganPecahan11awal(canv1,ArSisi[1],"The fraction below that is not equivalent to "," is ...");
	...
	function GetSoal12(){
		...
		var ss1=ArSisi[1][6]+" has a ribbon along it           ,";
		var ss2=ArSisi[1][7]+" along            ,";
		var ss3="dan "+ArSisi[1][8]+" along            ,";
		
		var ss
		ss = "So from this it can be seen that ... ";
	...
	function GetSoal18(){
		...
		var ss1=ArSisi[1][6]+" make a stick as long as             meters,";
		var ss2=ArSisi[1][7]+" make a stick as long as             meters,";
		
		var ss
		ss = "The total length of their sticks is ..."
	...
	function GetSoal20(canv){
		...
		const DrawPecahan = GambarBilanganPecahan20(canv,ArSisi[1],"The decimal fraction form of "," is ...");
	...
	function GetSoal22(){
		...
		var arrSalah=Aljabar[2];
		var ss
		ss = "The ordinary fraction form of "+StringDesimal(ArSisi[1])+" is ...";
	...
	function GetSoal23(){
		...
		var ss1="Mrs. "+ArSisi[1][0]+" bought          kg of wheat flour,";
		var ss2=StringDesimal(ArSisi[1][3])+" kg of rice,         kg of eggs.";
	...
	dd1.innerHTML="<p>Grade 4 Chapter 2 \u{2192} Fractions </p>";
	//dd1.innerHTML="";
	if(no==2){
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Pay attention to the fractional form below:</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Pay attention to the fractional form below:</p>";
		cc1.width = 150;
		cc1.height = 30;
		...
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Look at the following series of fractions!</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Look at the following series of fractions!</p>";
		cc1.width = 200;
		cc1.height = 35;
		cc2.width = 100;
		cc2.height = 184;
		ss = namefunc[no-1](cc1.id,cc2.id);
		dd2.innerHTML+="<br>The correct fraction to fill in the dots above to make the correct order is ...<br>";
		dd4.innerHTML+="Answer : "+ss[1];
		hidingElemen(cc3);
		hidingElemen(dd3);
	}else if(no==8){
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Look at the following two fractions!</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Look at the following two fractions!</p>";
		cc1.width = 200;
		cc1.height = 35;
		ss = namefunc[no-1](cc1.id);
		dd2.innerHTML+="<p>"+ss[0]+"</p>";
		...
		cc2.height = 184;
		ss = namefunc[no-1](cc1.id,cc2.id);
		dd2.innerHTML+="<br>The fractions above, if written in order from the smallest to the largest, become ...<br>";
		dd4.innerHTML+="Answer : "+ss[1];
		hidingElemen(cc3);
		hidingElemen(dd3);
	}else if(no==10){
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Look at the following fraction!</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Look at the following fraction!</p>";
		cc1.width = 300;
		cc1.height = 35;
		cc2.width = 200;
		cc2.height = 184;
		...
		ss = namefunc[no-1]();
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Given:</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Given:</p>";
		cc1.width = 350;
		cc1.height = 138;
		...
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Pay attention to the following addition of fractions</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Pay attention to the following addition of fractions</p>";
		cc1.width = 200;
		cc1.height = 35;
		cc2.width = 200;
		cc2.height = 184;
		ss = namefunc[no-1](cc1.id,cc2.id);
		dd2.innerHTML+="<p>The result of adding the fractions above is ...</p>";
		dd4.innerHTML+="Answer : "+ss[1];
		hidingElemen(cc3);
		hidingElemen(dd3);
	}else if(no==14){
		...
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Look at the subtraction of the following fractions</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Look at the subtraction of the following fractions</p>";
		cc1.width = 200;
		cc1.height = 35;
		cc2.width = 200;
		cc2.height = 184;
		ss = namefunc[no-1](cc1.id,cc2.id);
		dd2.innerHTML+="<p>The result of subtracting the fractions above is ...</p>";
		dd4.innerHTML+="Answer : "+ss[1];
		hidingElemen(cc3);
		hidingElemen(dd3);
	}else if(no==16){
		...
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Pay attention to the following mixed fraction operations.</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Pay attention to the following mixed fraction operations.</p>";
		cc1.width = 200;
		cc1.height = 35;
		cc2.width = 200;
		cc2.height = 184;
		...
		ss = namefunc[no-1]();
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". "+ss[2][1][3]+" have money amounting to Rp"+StringRibuan(ss[2][1][0])+",00.</p>";
		else			dd1.innerHTML+="<p>"+nourut+". "+ss[2][1][3]+" have money amounting to Rp"+StringRibuan(ss[2][1][0])+",00.</p>";
		cc1.width = 435;
		cc1.height = 35;
		dd2.innerHTML+="<p>How much money is left in "+ss[2][1][3]+" now?</p>";
		const DrawPecahan19a = GambarBilanganPecahan19(cc1.id,[ss[2][1][1],ss[2][1][2]],["As much as","part of the money was used to buy goods."]);
		...
		cc1.width = 350;
		cc1.height = 92;
		dd2.innerHTML+="<p>The total weight of Mrs. "+ss[2][1][0]+"'s shopping is ...</p>";
		...
		if(nourut==0)	dd1.innerHTML+="<p>"+no+". Consider the following mixed operations:</p>";
		else			dd1.innerHTML+="<p>"+nourut+". Consider the following mixed operations:</p>";
		cc1.width = 300;
		cc1.height = 42;
		ss = namefunc[no-1](cc1.id);
		dd2.innerHTML+="<p>"+ss[0]+"</p>";
