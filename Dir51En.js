function Print51(no,d1,c1,d2,c2,d3,c3,d4,nourut){
	...
	function MyBilanganCacah1(){
		...
		function NamaKeAngka(ar){
			...
			var puluh = ["","ten","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety","one hundred"];
			var belas = ["ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen"];
			...
			if(ar[0]==1){
				nn = ar[0]*10+ar[1]
				nncvrt = nn-10;
				depan = belas[nncvrt]+" thousand";
			}else{
				mm = ar[0];
				nn = ar[1];
				mmcvrt = mm;
				nncvrt = nn;
				depan = puluh[mmcvrt]+" "+angka[nncvrt]+" thousand";
				//if(nn==0)	depan = angka[mmcvrt]+" puluh ribu";
				if(nn==0)	depan = puluh[mmcvrt]+" thousand";
			}
			// tengah
			mm = ar[2];
			mmcvrt = mm;
			tengah = angka[mmcvrt]+" hundred";
			if(mmcvrt==0)	tengah = "one hundred";
			if(mm==0)		tengah = "";
			// belakang
			if(ar[3]==1){
				nn = ar[3]*10+ar[4]
				...
				mmcvrt = mm;
				nncvrt = nn;
				belakang = puluh[mmcvrt]+" "+angka[nncvrt];
				if(nn==0)	belakang = puluh[mmcvrt]+"";
				if(mm==0)	belakang = angka[nncvrt];
			}
			var bfix = depan+" "+tengah+" and "+belakang;
			return bfix;
		}
	...
	function MyBilanganCacah2(){
		...
		function AngkaKeNama(ar){
			...
			if(ar[0]==1){
				...
				if(ar[1]==1)		depan = "one thousand";
				else if(ar[1]==0)	depan = "";
				else 				depan = angka[nncvrt]+" thousand";
			}else{
				mm = ar[0];
				nn = ar[1];
				mmcvrt = mm;
			...
			if(ar[3]==1){
				...
				mmcvrt = mm-1;
				nncvrt = nn-1;
				belakang = angka[mmcvrt]+" hundred "+angka[nncvrt];
				if(nn==0)	belakang = angka[mmcvrt]+" hundred";
				if(mm==0)	belakang = angka[nncvrt];
	...
	function MyBilanganCacah3(){
		...
		var ArBenar = [[arAngka[0],"tens of thousands"],
						[arAngka[1],"thousands"],
						[arAngka[2],"hundreds"],
						[arAngka[3],"tens"],
						[arAngka[4],"units"]
						]
		var ArSalah = ["tens of thousands","thousands","hundreds","tens","units"]
	...
	function MyBilanganCacah16(){
		...
		var SoalBenar = ["The number "+arAngka[0]+" in the number indicating the area of the zoo occupies the tens of thousands place value",
					   "The number "+arAngka[1]+" in the number indicating the area of the zoo occupies the thousands place value",
					   "The number "+arAngka[2]+" in the number indicating the area of the zoo occupies the hundreds place value",
					   "The number "+arAngka[3]+" in the number indicating the area of the zoo occupies the tens place value",
					   "The number "+arAngka[4]+" in the number indicating the area of the zoo occupies the unit place value"
					   ]
		var SoalSalah = [
					   "The number "+arAngka[0]+" in the number indicating the area of the zoo occupies the thousands place value",
					   "The number "+arAngka[0]+" in the number indicating the area of the zoo occupies the hundreds place value",
					   "The number "+arAngka[0]+" in the number indicating the area of the zoo occupies the tens place value",
					   "The number "+arAngka[0]+" in the number indicating the area of the zoo occupies the unit place value",
					   "The number "+arAngka[1]+" in the number indicating the area of the zoo occupies the tens of thousands place value",
					   
					   "The number "+arAngka[1]+" in the number indicating the area of the zoo occupies the hundreds place value",
					   "The number "+arAngka[1]+" in the number indicating the area of the zoo occupies the tens place value",
					   "The number "+arAngka[1]+" in the number indicating the area of the zoo occupies the unit place value",
					   "The number "+arAngka[2]+" in the number indicating the area of the zoo occupies the tens of thousands place value",
					   "The number "+arAngka[2]+" in the number indicating the area of the zoo occupies the thousands place value",
					   
					   "The number "+arAngka[2]+" in the number indicating the area of the zoo occupies the tens place value",
					   "The number "+arAngka[2]+" in the number indicating the area of the zoo occupies the unit place value",
					   "The number "+arAngka[3]+" in the number indicating the area of the zoo occupies the tens of thousands place value",
					   "The number "+arAngka[3]+" in the number indicating the area of the zoo occupies the thousands place value",
					   "The number "+arAngka[3]+" in the number indicating the area of the zoo occupies the hundreds place value",
					   
					   "The number "+arAngka[3]+" in the number indicating the area of the zoo occupies the unit place value",
					   "The number "+arAngka[4]+" in the number indicating the area of the zoo occupies the tens of thousands place value",
					   "The number "+arAngka[4]+" in the number indicating the area of the zoo occupies the thousands place value",
					   "The number "+arAngka[4]+" in the number indicating the area of the zoo occupies the hundreds place value",
					   "The number "+arAngka[4]+" in the number indicating the area of the zoo occupies the tens place value"
	...
	function MyBilanganCacah17(){
		...
		var SoalBenar = [
					   "The number "+arAngka[0]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[0]*10000),
					   "The number "+arAngka[1]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[1]*1000),
					   "The number "+arAngka[2]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[2]*100),
					   "The number "+arAngka[3]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[3]*10),
					   "The number "+arAngka[4]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[4]*1)
					   ]
		var SoalSalah = [
					   "The number "+arAngka[0]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[0]*1000),
					   "The number "+arAngka[0]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[0]*100),
					   "The number "+arAngka[0]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[0]*10),
					   "The number "+arAngka[0]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[0]*1),
					   "The number "+arAngka[1]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[1]*10000),
					   
					   "The number "+arAngka[1]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[1]*100),
					   "The number "+arAngka[1]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[1]*10),
					   "The number "+arAngka[1]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[1]*1),
					   "The number "+arAngka[2]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[2]*10000),
					   "The number "+arAngka[2]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[2]*1000),
					   
					   "The number "+arAngka[2]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[2]*10),
					   "The number "+arAngka[2]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[2]*1),
					   "The number "+arAngka[3]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[3]*10000),
					   "The number "+arAngka[3]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[3]*1000),
					   "The number "+arAngka[3]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[3]*100),
					   
					   "The number "+arAngka[3]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[3]*1),
					   "The number "+arAngka[4]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[4]*10000),
					   "The number "+arAngka[4]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[4]*1000),
					   "The number "+arAngka[4]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[4]*100),
					   "The number "+arAngka[4]+" in the number that shows the area of the zoo matches the value "+StringRibuan(arAngka[4]*10)
	...
	function MyBilanganCacah18(){
		...
		function NamaKeAngka(ar){
			...
			var belas = ["ten","eleven","twelve","thirteen","fourteen","fifteen","sixteen","seventeen","eighteen","nineteen"];
			var angka = ["","one","two","three","four","five","six","seven","eight","nine","ten"];
			var angkapuluh = ["ten","twenty","thirty","forty","fifty","sixty","seventy","eighty","ninety","one hundred"];
			...
			if(ar[0]==1){
				...
				mmcvrt = mm-1;
				nncvrt = nn;
				depan = angkapuluh[mmcvrt]+" "+angka[nncvrt]+" thousand";
				//if(nn==0)	depan = angka[mmcvrt]+" puluh ribu";
				if(nn==0)	depan = angkapuluh[mmcvrt]+" thousand";
			}
			// tengah
			mm = ar[2];
			mmcvrt = mm;
			...
			if(ar[3]==1){
				nn = ar[3]*10+ar[4]
				nncvrt = nn-10;
				belakang = "and "+belas[nncvrt];
			}else{
				mm = ar[3];
				nn = ar[4];
				mmcvrt = mm-1;
				nncvrt = nn;
				belakang = "and "+angkapuluh[mmcvrt]+" "+angka[nncvrt];
				if(nn==0)	belakang = "and "+angkapuluh[mmcvrt]+"";
				if(mm==0)	belakang = "and "+angka[nncvrt];
			}
	...
	function GetSoal1(){
		...
		ss = "The number "+ArSisi[0]+" can be written ....";
	...
	function GetSoal2(){
		...
		ss = "The price of a sandal is "+ArSisi[0]+" rupiah. The symbol for this number can be read ....";
	...
	function GetSoal3(){
		...
		ss = "The number "+ArSisi[0]+" in the number symbol "+ArSisi[1]+" has a place value of ....";
	...
	function GetSoal4(){
		...
		ss = Nama[0]+" has the number "+ArSisi[0]+" tens of thousands "+ArSisi[1]+" thousands "+ArSisi[2]+" hundreds "+ArSisi[3]+" tens "+ArSisi[4]+" units. The number is ....";
	...
	function GetSoal5(){
		...
		ss = "The value of the number "+ArSisi[0]+" in the number "+ArSisi[1]+" is ....";
	...
	function GetSoal6(){
		...
		ss = "The numbers are given as follows "+StringRibuan(ArSisi[0][0])+" ; "+StringRibuan(ArSisi[0][1])+" ; "+StringRibuan(ArSisi[0][2])+" ; "+StringRibuan(ArSisi[0][3])+". <br>If sorted from the largest to ....";
	...
	function GetSoal7(){
		...
		ss = "The following inequality is true....";
	...
	function GetSoal8(){
		...
		ss = "The number below which is the result of adding "+StringRibuan(ArSisi[0])+" and "+StringRibuan(ArSisi[1])+" is ....";
	...
	function GetSoal9(){
		...
		ss = "The number below which is the result of subtracting "+StringRibuan(ArSisi[0])+" and "+StringRibuan(ArSisi[1])+" is ....";
	...
	function GetSoal10(){
		...
		ss = "The number below which is the result of "+StringRibuan(ArSisi[0])+" × "+ArSisi[1]+" is ....";
	...
	function GetSoal11(){
		...
		ss = "The result of "+StringRibuan(ArSisi[0])+" : "+ArSisi[1]+" is ....";
	...
	function GetSoal12(){
		...
		ss = "In "+ArSisi[1]+" sacks can contain "+StringRibuan(ArSisi[0])+" oranges. So the number of oranges in each sack is ....";
	...
	function GetSoal13(){
		...
		ss = "The amount of "+Nama[0]+" and "+Nama[1]+" money is Rp"+StringRibuan(ArSisi[0])+".00. If the "+Nama[0]+" money is Rp"+StringRibuan(ArSisi[1])+".00 then the "+Nama[1]+" money is ....";
	...
	function GetSoal14(){
		...
		ss = "In one day and night we are advised to consume as much as "+StringRibuan(ArSisi[0])+" ml of drinking water. <br>So in one week we need as much as .... ml of drinking water.";
	...
	function GetSoal15(){
		...
		ss = "The price of 1 notebook is Rp"+StringRibuan(ArSisi[0])+".00. If you buy "+ArSisi[1]+" notebook, you have to pay ....";
	...
	function GetSoal16(){
		...
		ss = "A zoo has a land area of "+StringRibuan(ArSisi[0])+" km². Consider the following statements!<br>";
		ss += ""+ArSisi[1][0]+"<br>";
		ss += ""+ArSisi[1][1]+"<br>";
		ss += ""+ArSisi[1][2]+"<br>";
		ss += ""+ArSisi[1][3]+"<br>";
		ss += "The correct statement is shown in number ....";
	...
	function GetSoal17(){
		...
		ss = "A National Park has a land area of "+StringRibuan(ArSisi[0])+" km². Consider the following statements!<br>";
		ss += ""+ArSisi[1][0]+"<br>";
		ss += ""+ArSisi[1][1]+"<br>";
		ss += ""+ArSisi[1][2]+"<br>";
		ss += ""+ArSisi[1][3]+"<br>";
	...
	function GetSoal18(){
		...
		ss = "An island has an area of approximately "+ArSisi[0]+" square kilometers. So the area of the island can be written as ....";
	...
	function GetSoal19(){
		...
		ss = "The number "+ArSisi[0]+" when decomposed becomes ....";
	...
	function GetSoal20(){
		...
		ss = "The population of Safe Village is "+StringRibuan(ArSisi[0][0])+" people. The population of Clean Village is "+StringRibuan(ArSisi[0][1])+" people. Meanwhile, the population of Cerah Ceria Village is "+StringRibuan(ArSisi[0][2])+" people. Sort the villages from the one with the most residents!";
	...
	dd1.innerHTML="<p>Grade 5 Chapter 1 \u{2192} Whole Numbers up to 100,000 </p>";
	//dd1.innerHTML="";
